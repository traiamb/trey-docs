# Creating Custom Runtime Adapter

> **Status**: `Future` | **Category**: Runtime Adapters

Design a runtime adapter that emits normalized events and respects daemon controls.
