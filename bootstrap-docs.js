...
.trey-inline-footer .md-footer__link {
  display: flex !important;
  align-items: center !important;
  gap: 0.35rem !important; /* balanced neat gap */
  text-decoration: none !important;
  width: 49% !important; /* force button to expand and fill space */
  max-width: 49% !important;
  background-color: transparent !important;
  padding: 0.35rem 0.5rem !important; /* padding restored for hover background look */
  margin: 0 !important;
  border-radius: 0.375rem !important;
