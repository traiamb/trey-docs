...
<div class="trey-page-header">
  <div class="trey-header-meta">
    <span class="trey-status-badge status-${p.status.toLowerCase()}">${p.status}</span>
    <span class="trey-category-badge">${p.category}</span>
  </div>
  <h1 class="trey-page-title">${p.title}</h1>
  <p class="trey-page-description">${p.description}</p>
</div>
