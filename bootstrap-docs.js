...
fs.writeFileSync(path.join(DOCS_DIR, 'index.md'), `# Trey Documentation\n\nWelcome to Trey Documentation. Use the tabs above and sidebar to navigate our system architecture, security primitives, and execution lifecycles.`, 'utf-8');
