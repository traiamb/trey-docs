...
<div class="trey-page-header">
  ...
  <h1 class="trey-page-title">Runtime Adapter Architecture</h1>
  <p class="trey-page-description">A shared contract for probing, starting, stopping, and normalizing runtime events.</p>
</div>
...
Runtime Adapter Architecture covers runtime abstraction inside Trey, Grovya Labs' local-first AI engineering operations cockpit. It explains how the console, Spring Boot control plane, Go daemon, git worktrees, PostgreSQL records, runtime adapters, and human approval process work together for this area.
