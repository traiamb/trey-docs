...
<div class="trey-page-header">
  ...
  <h1 class="trey-page-title">Daemon vs Agent</h1>
  <p class="trey-page-description">Separate logical AI roles from the Go daemon process that executes and verifies work.</p>
</div>
