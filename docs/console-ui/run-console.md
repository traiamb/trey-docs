...
<div class="trey-page-header">
  ...
  <h1 class="trey-page-title">Run Console</h1>
  <p class="trey-page-description">Watch live agent output, daemon logs, telemetry, changed files, diff proposal, and approval state.</p>
</div>
