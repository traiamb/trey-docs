...
<div class="trey-page-header">
  ...
  <h1 class="trey-page-title">Integrations Screen</h1>
  <p class="trey-page-description">Configure GitHub, Jira, and future external systems from one control surface.</p>
</div>
