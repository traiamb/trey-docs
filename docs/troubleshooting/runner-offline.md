...
<div class="trey-page-header">
  ...
  <h1 class="trey-page-title">Runner Offline</h1>
  <p class="trey-page-description">Bring a runner back online and understand stale heartbeat behavior.</p>
</div>
...
Runner Offline covers runner diagnostics inside Trey, Grovya Labs' local-first AI engineering operations cockpit. It explains how the console, Spring Boot control plane, Go daemon, git worktrees, PostgreSQL records, runtime adapters, and human approval process work together for this area.
...
- [Logs Not Streaming](../troubleshooting/logs-not-streaming.md)
