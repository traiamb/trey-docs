...
<div class="trey-page-header">
  ...
  <h1 class="trey-page-title">Runtime Not Detected</h1>
  <p class="trey-page-description">Resolve missing binaries, PATH problems, unsupported versions, and adapter probe failures.</p>
</div>
...
Runtime Not Detected covers runtime diagnostics inside Trey, Grovya Labs' local-first AI engineering operations cockpit. It explains how the console, Spring Boot control plane, Go daemon, git worktrees, PostgreSQL records, runtime adapters, and human approval process work together for this area.
